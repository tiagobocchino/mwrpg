...
- **Não testado ponta a ponta ainda** — precisa do Tiago aplicar o Manual 05 (URL Configuration) e depois testar login real (clicar o link mágico) + uma campanha completa em produção.
